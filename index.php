...
if ($_SERVER['REQUEST_METHOD'] == "GET" ){
        ...
        if ( isset($_GET['orden'])){
            switch ($_GET['orden']) {
                ...
                case "Borrar"   : ($rol==1)? crudBorrar   ($_GET['id']) : require_once "app/views/nopermisos.php"; break;
                case "Modificar": ($rol==1)? crudModificar($_GET['id']) : require_once "app/views/nopermisos.php"; break;
...
// Cargo genero la vista con la lista por defecto si hay una sesión iniciada
if ( ob_get_length() == 0 && isset($_SESSION['login'])){
