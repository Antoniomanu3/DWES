...
//Función que devuleve la ruta de su locaclizacion medainte ip
function getLoca($ip){
...
//Devuelvo la ruta de imagen si existe sino devuelvo una imagen aleatoria generada por robohash.org
function getFoto($id)
{
    $nnum = strlen($id);
    $foto = "./app/uploads/" . generanombreimg($nnum, $id) . ".jpg";
    //Foto por defecto
    $fdefecto = "https://robohash.org/" . $id;
    ...
    /*  $numal=rand($id,999999);
        $fdefecto.=$numal; */

    return $fdefecto;
}

//Genero el nombre de la imagen a partir del id del cliente
